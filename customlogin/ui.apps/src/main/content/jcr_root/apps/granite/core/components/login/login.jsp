...
--%><%@page session="false"
        ...
        import="java.util.HashMap,
                  ...
                  com.lina.customlogin.core.services.LoginBackgroundImageService,
                  java.util.Calendar"%><%
...
<div id="wrap" role="main">
    <div id="backgrounds">
        ...
        LoginBackgroundImageService loginBgImageService = sling.getService(LoginBackgroundImageService.class);

        if (loginBgImageService != null) {
            css_id = loginBgImageService.getBackgroundImageCssId();
        }
